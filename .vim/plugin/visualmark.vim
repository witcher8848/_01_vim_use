...
if !hasmapto('<Plug>Vm_remove_all_signs')
  map <silent> <unique> mr <Plug>Vm_remove_all_signs 
endif
nnoremap <silent> <script> <Plug>Vm_remove_all_signs :call Vm_remove_all_signs()<cr>

if !hasmapto('<Plug>Vm_goto_next_sign')
  map <unique> <unique> mn <Plug>Vm_goto_next_sign
endif
nnoremap <silent> <script> <Plug>Vm_goto_next_sign	:call Vm_goto_next_sign()<cr>

if !hasmapto('<Plug>Vm_goto_prev_sign')
  map <unique> <unique> mp <Plug>Vm_goto_prev_sign
endif
