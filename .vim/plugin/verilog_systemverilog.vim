...
syn keyword ovmMethod            insert_phase run_global_phase run_test stop_request
syn keyword ovmDeprecatedClass   ovm_test_top
syn keyword ovmDeprecatedMethod  print_topology print_unit print_unit_list print_units
...
syn keyword uvmMethod            accept_tr apply_config_settings begin_child_tr begin_tr build_phase check clone
...
syn keyword uvmMethod            set_config_string set_inst_override set_inst_override_by_type set_name run_phase
syn keyword uvmMethod            set_report_default_file_hier set_report_id_action_hier set_report_id_file_hier
syn keyword uvmMethod            set_report_severity_action_hier set_report_severity_file_hier final_phase
...
syn keyword uvmMethod            start_of_simulation_phase status stop suspend main_phase extract_phase report_phase
...
syn keyword uvmClass             uvm_config_setting reset_phase pre_reset_phase post_reset_phase
...
syn keyword uvmMethod            build check_port_connections end_of_elaboration_phase
...
syn keyword uvmClass             uvm_sequence_base uvm_phase uvm_resource uvm_resource_db uvm_config_db uvm_domain
...
syn keyword uvmClass             uvm_tlm_fifo uvm_reg_sequence uvm_reg_adapter uvm_reg_backdoor uvm_reg_predictor uvm_reg_model
syn keyword uvmClass             uvm_reg_item uvm_reg_map uvm_reg_fifo uvm_reg_block uvm_mem uvm_mem_mam uvm_reg uvm_reg_cbs
syn keyword uvmClass             uvm_reg_file uvm_vreg uvm_vreg_field 
