...
setlocal indentkeys+==`urm_object_utils_end,=`urm_field_utils_end,=`urm_unit_utils_end
setlocal indentkeys+==`urm_unit_base_utils_end,=`ovm_field_utils_end,=`ovm_object_utils_end
setlocal indentkeys+==`uvm_field_utils_end,=`uvm_object_utils_end
...
function GetVerilog_SystemVerilogIndent()
  ...
  elseif last_line =~ '^\s*\<\(function\|task\|class\|package\)\>' ||
    ...
    \ last_line =~ '^\s*`\<\(urm_object_utils_begin\|urm_field_utils_begin\|urm_unit_utils_begin\)\>' ||
    \ last_line =~ '^\s*`\<\(urm_unit_base_utils_begin\|ovm_field_utils_begin\|ovm_object_utils_begin\)\>' ||
    \ last_line =~ '^\s*\`<\(ovm_component_utils_begin\|ovm_sequence_utils_begin\|ovm_sequencer_utils_begin\)\>' ||
    \ last_line =~ '^\s*`\<\(uvm_field_utils_begin\|uvm_object_utils_begin\)\>' ||
  ...
  if curr_line =~ '^\s*\<\(join\|join_any\|join_none\|\|end\|endcase\|while\)\>' ||
      ...
      \ curr_line =~ '^\s*`\<\(urm_object_utils_end\|urm_field_utils_end\|urm_unit_utils_end\)\>' ||
      \ curr_line =~ '^\s*`\<\(urm_unit_base_utils_end\|ovm_field_utils_end\|ovm_object_utils_end\)\>' ||
      \ curr_line =~ '^\s*`\<\(ovm_component_utils_end\|ovm_sequence_utils_end\|ovm_sequencer_utils_end\)\>' ||
      \ curr_line =~ '^\s*`\<\(uvm_field_utils_end\|uvm_object_utils_end\)\>' ||
