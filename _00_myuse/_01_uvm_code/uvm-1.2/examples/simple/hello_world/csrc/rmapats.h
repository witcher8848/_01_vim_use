...
typedef struct _RmaMultiInputTable {
    ...
    UB  * I904;
    UB  * I905;
    struct _RmaMultiInputTable * I879;
    struct _RmaMultiInputTable * I907;
} RmaMultiInputTable;
...
typedef struct {
    U  I714;
    U  I722;
    RmaThreadSchedCompiledLoads  * I1012;
...
typedef struct {
    ...
    US  I1072;
    US  I1073;
    RemoteDbsedLoad   I1074[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I879;
    struct TableAssign_ * I797;
    U  I5;
    U  I1076 :1;
    U  I1077 :1;
    U  I1078 :2;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I879;
    struct TableAssignLayoutOnClk_ * I797;
    U  I5;
    U  I1076 :1;
    U  I1077 :1;
    U  I1078 :2;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I879;
    struct TableAssignLayoutOnClkOpt_ * I797;
    U  I1090;
    U  I1076 :1;
    U  I1077 :1;
    U  I1078 :2;
    ...
    U  I1085 :1;
    U  I368 :13;
    RmaSeqPrimOutputOnClkOpt  I1087;
    RmaSeqPrimOutputEblkData  I1091;
...
typedef struct RmaNonEdgeLoadHdr1_ {
    ...
    UB  I1155;
    UB  I976;
    RmaNonEdgeLoadData1  * I1056;
    RmaNonEdgeLoadData1  * I797;
    void * I1156;
} RmaNonEdgeLoadHdr1;
...
typedef struct RmaChildClockPropList1_ {
    RmaChildClockProp  * I1056;
    RmaChildClockProp  * I797;
...
struct futq_slot1 {
    U  I754;
    struct futq_slot2  I755[32];
};
struct futq_info {
    scalar  * I749;
    U  I750;
    U  I751;
    struct futq_slot1  I752[32];
};
struct futq {
    struct futq * I739;
    struct futq * I741;
...
struct dummyq_struct {
    ...
    int I1253;
    int I1254;
    struct vcs_globals_t * I1255;
    clock_struct  I1256;
    unsigned long long I1257;
    EBLK  * I1258;
    EBLK  * I1259;
    void * I1260;
};
...
void  hs_0_M_0_1__simv_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1301, U  did);
...
void  hsG_0__0 (struct dummyq_struct * I1287, EBLK  * I1281, U  I685);
#ifdef __cplusplus
}
#endif
